...
Currently a third-semester IT student at **FPT Aptech** (FPT Aptech International IT Education Center, Ho Chi Minh City), specializing in Web Programming. Expanding into the **Java ecosystem** — Java Core → Spring Boot — alongside deepening my understanding of MMO business logic and systems design.
...
[![Backend](https://skillicons.dev/icons?i=nestjs,nodejs,dotnet,cs,express,postgres,mongodb&perline=7)](https://skillicons.dev)
